...
<html class="no-js h-100" lang="en">
	...
	<body class="h-100">
                                        ...
                                        <ul class="list-group list-group-flush text-center">
                                            <li class="list-group-item px-3 pb-2">
                                                <div class="m-2 mx-auto">
                                                    <img class="rounded-circle" src="http://localhost/hmkk.org/assets/administrator/images/avatars/0.jpg" alt="User Avatar" width="110">
                                                </div>
        ...
        <script src="<?= base_url("assets/administrator/") ?>scripts/app/app-blog-new-post.1.1.0.js"></script>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $("#kembali").click(function() {
                    ...
                    .then((yes) => {
                        if (yes) {
                            window.location.assign(`<?= base_url("administrator/")."artikel" ?>`);
                        }
                    });
                });
            });
                    ...
                    success: function(response) {
                        ...
                        if (response.status === 200) {
                            ...
                            .then((value) => {
                                ...
                                window.location.assign(`<?= base_url("administrator/")."artikel/" ?>`+response.keterangan.id);
                            });
                        } else {
